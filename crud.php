...
if ($conn->connect_error) {
	...
	$sql = "SELECT * FROM korisnici  limit $eu, $limit";
	$result1 = mysqli_query($conn, $sql);
}
		...
		<div class="table-responsive">
			<div class="table-wrapper">
				<div class="table-title">
					<div class="row">
						<div class="">
							<a href="#logout" class="btn btn-info btn-lg" span class="glyphicon glyphicon-log-out" data-toggle="modal"> Odjavi se
							</a>
						</div>
						<div class="col-sm">
					...
					<tbody>
						<?php while ($row1 = mysqli_fetch_array($result1)) :; ?>
							<tr>
								...
								<td><a href="#editEmployeeModal" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Uredi">&#xE254;</i></a>
									<a href="#deleteEmployeeModal" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Obriši">&#xE872;</i></a>
								</td>
							</tr>
						<?php endwhile; ?>
					</tbody>
				...
				<div class="clearfix">
					<div class="hint-text">Prikazuje <b><?php echo "$this1" ?></b> od <b><?php echo "$num_rows" ?></b> zapisa</div>
					<ul class="pagination">
			...
			<div class="modal-content">
				<form action="logout.php" method="post">
					<div class="modal-header">
						<h4 class="modal-title">Želite li da se odjavite?</h4>
					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Otkaži">
						<input type="submit" class="btn btn-info" value="Odjavi se">
					</div>
				</form>
			</div>
		</div>
			...
			<div class="modal-content">
				<form>
					...
					<div class="modal-body">
						...
						<p class="text-warning"><small>Ova akcija ne može biti opozvana!</small></p>
					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Otkaži">
